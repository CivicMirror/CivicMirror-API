...
urlpatterns = [
    ...
    path("tasks/poll-upcoming-results/", views.poll_upcoming_results_trigger, name="internal-poll-upcoming-results"),
    ...
    path("tasks/sync-hi-olvr/", views.sync_hi_olvr_trigger, name="internal-sync-hi-olvr"),
    ...
    path("tasks/sync-nc-candidates/", views.sync_nc_candidates_trigger, name="internal-sync-nc-candidates"),
    ...
    path("tasks/sync-ny-elections/", views.sync_ny_elections_trigger, name="internal-sync-ny-elections"),
    path("tasks/sync-ny-races/", views.sync_ny_races_trigger, name="internal-sync-ny-races"),
    ...
    path("tasks/discover-mn-sos/", views.discover_mn_sos_trigger, name="internal-discover-mn-sos"),
